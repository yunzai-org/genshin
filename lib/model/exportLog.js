import { downFile, ConfigController } from 'yunzai';
...
class ExportLog extends base {
    ...
    async exportJson() {
        ...
        let data = {
            info: {
                ...
                export_app_version: ConfigController.package.version
            },
            list
        };
        if (this.e.isSr) {
    ...
    dealJson(list) {
        ...
        /** 倒序 */
        if (moment(list[0].time).format('x') <
