...
import { sleep, downFile } from 'yunzai';
...
class GachaLog extends base {
    constructor(e) {
        ...
        this.model = 'gachaLog';
        if (!e.isSr && e.msg)
            e.isSr = /\/(common|hkrpg)\//.test(e.msg);
    ...
    getServer() {
        switch (String(this.uid).slice(0, -8)) {
            case '1':
            case '2':
                return this.e.isSr ? 'prod_gf_cn' : 'cn_gf01';
            case '5':
                return this.e.isSr ? 'prod_qd_cn' : 'cn_qd01';
            case '6':
                return this.e.isSr ? 'prod_official_usa' : 'os_usa';
            case '7':
                return this.e.isSr ? 'prod_official_euro' : 'os_euro';
            case '8':
            case '18':
                return this.e.isSr ? 'prod_official_asia' : 'os_asia';
            case '9':
                return this.e.isSr ? 'prod_official_cht' : 'os_cht';
        }
        return 'cn_gf01';
    }
}

export { GachaLog as default };
